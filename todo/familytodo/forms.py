...
class TaskAddForm(forms.Form):
    ...
    task_family = forms.CharField(label="Task family", max_length=30, required=False, disabled=True, widget=forms.HiddenInput())
    ...
    task_child = forms.ChoiceField(label="Child", choices=[('Zala','Zala')])
