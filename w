...
def add_schedule(request):
    ...
    if request.method == 'POST':
        ...
        ''' extract existing schedules for above family '''
        ...
        if scheduleform.is_bound and scheduleform['sc_desc'].data != None:
            ...
            try:
                ...
                return render(request, 'schedule_add.html',
                        {'schedule_form': schedule_form,
                         'family': family_name, 'parent': parent_name,
                         'schedules': existing_schedules, 'error': str(e)})
...
def add_child(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'child_add.html',
